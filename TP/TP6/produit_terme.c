...
Pour chacun des exemples suivants, récupérer le code associé et essayer de le vectoriser en utilisant :
— les options de vectorisation automatique du compilateur ;
— les directives OpenMP 4.0 ;
— les intrinsèques AVX2.

Compilation avec l'option -mavx2
*/
int main()
{
	for (int i = 0; i < N; i++) {
